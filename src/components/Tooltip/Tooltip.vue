<template>
  <div class="j-tooltip" v-on="outerEvents" ref="popperContainerNode">
    <div class="j-tooltip__trigger" ref="triggerNode" v-on="events">
      <slot></slot>
    </div>
    <Transition :name="transition">
      <div v-if="isOpen" class="j-tooltip__popper" ref="poperNode">
...
watch(
  ...
  (newValue) => {
    if (newValue) {
      if (triggerNode.value && poperNode.value) {
